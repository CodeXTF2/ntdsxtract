...
print("Header checksum:     %s" % hexstr(header[:4][::-1]))
print("Signature:           %s" % hexstr(header[4:8][::-1]))
print("File format version: %s" % hexstr(header[8:12][::-1]))
print("File type:           %s" % hexstr(header[12:16][::-1]))
print("Page size:           %d bytes" % pagesize)
print("DB time:             %s" % hexstr(header[16:24][::-1]))
